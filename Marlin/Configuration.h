...
#define STRING_CONFIG_H_AUTHOR "AON3D" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "AON-M2"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 40, 40, 400, 640 }
 ...
 */
    ...
    #define DEFAULT_MAX_FEEDRATE          { 499*X_MAX_FEEDRATE_SCALAR, 499*Y_MAX_FEEDRATE_SCALAR, 10*Z_MAX_FEEDRATE_SCALAR, 30*E_MAX_FEEDRATE_SCALAR }
#else
...
//distance to hop when using: G92 Axx
#define Z_ADJUST_HOP_DISTANCE 1
...
#define Z_MAX_POS 620 // investigate max travel distance and confirm
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_SCRIPT "G28 X\nM0" //Home X, Wait. M108 to continue.
#endif
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (X_MIN_POS)    // X point for Z homing when homing all axis (G28).
  #define Z_SAFE_HOMING_Y_POINT (Y_MIN_POS)    // Y point for Z homing when homing all axis (G28).
#endif
